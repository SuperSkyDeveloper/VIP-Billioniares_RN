...
const PostDetailView = (props) => {
  ...
  return (
    <View style={sharedStyles.container}>
      <StatusBar />
      <KeyboardView
        contentContainerStyle={[sharedStyles.contentContainer, { backgroundColor: themes[theme].backgroundColor, height: '100%', paddingTop: 50 }]}
        ...
        <View style={{ height: 40, borderBottomWidth: 1, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 15, borderBottomColor: themes[theme].separatorColor }}>
          ...
          <Text style={[styles.profileName, { color: themes[theme].activeTintColor, fontSize: 18, marginLeft: 10 }]}>{I18n.t(post.type)}</Text>
        </View>
        {isLoading && (
          <ActivityIndicator absolute theme={theme} size={'large'} />
        )}
          ...
          <View
            ...
            <View style={styles.owner}>
              ...
              <View style={styles.profileInfo}>
                <Text style={[styles.profileName, { color: themes[theme].activeTintColor }]}>{post.owner.displayName}</Text>
                <Text style={{ color: themes[theme].infoText, fontSize: 14, marginTop: 5 }}>{getUserRepresentString(post.owner)}</Text>
              </View>
              <PopupMenu
                theme={theme}
            ...
            <View style={styles.likes}>
              <Text style={[styles.likesContent, { color: themes[theme].activeTintColor }]}>{post.likes?.length ?? 0}</Text>
              <Text style={{ color: themes[theme].infoText, fontSize: 14, marginLeft: 4 }}>{(post.likes?.length ?? 0) <= 1 ? I18n.t('Like') : I18n.t('Likes')}</Text>
            </View>
            <View style={[styles.separator, { backgroundColor: themes[theme].separatorColor }]} />
                  ...
                  <View style={styles.commentMain}>
                    ...
                    <View
                      ...
                      <View style={{
                        ...
                        <Text style={[styles.commentAccountName, { fontWeight: 'bold', color: themes[theme].activeTintColor }]}>
                          {c.displayName}
                        </Text>
                      ...
                      <Text style={[styles.commentText, { color: themes[theme].activeTintColor, marginTop: 4 }]}>{c.text}</Text>
                    </View>
                  </View>
        ...
        {photoMode && (
          <View style={{ position: 'absolute', left: 0, right: 0, top: 0, bottom: 0, backgroundColor: '#000000E0' }}>
            ...
            <View style={{ position: 'absolute', left: 0, right: 0, top: 40, bottom: 0, justifyContent: 'space-between' }}>
              <View>
