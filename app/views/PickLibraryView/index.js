...
const PickLibraryView = (props) => {
  ...
  return (
    <View style={[sharedStyles.container, { backgroundColor: themes[theme].navbarBackground }]}>
      <SafeAreaView style={[sharedStyles.contentContainer, { backgroundColor: themes[theme].backgroundColor, paddingTo: 20, paddingHorizontal: 20 }]}>
        <StatusBar />
        {isLoading && (
        ...
        {data.length ? (
          ...
          <View style={styles.emptyContainer}>
            <Text style={[styles.emptyText, { color: themes[theme].activeTintColor }]}>{I18n.t('No_files_in_device')}</Text>
          </View>
        )}
        {showGallery && (
