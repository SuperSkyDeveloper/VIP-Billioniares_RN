...
const SecurityView = (props) => {
  ...
  return (
    <View
      ...
      <KeyboardView style={[sharedStyles.contentContainer, { flex: 1, overflow: 'hidden', paddingHorizontal: 10, backgroundColor: themes[theme].backgroundColor }]} keyboardVerticalOffset={128}>
        <StatusBar />
